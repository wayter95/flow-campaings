...
import { ArrowLeft, Variable, Copy, Check } from "lucide-react";
import Link from "next/link";
import { createWhatsAppTemplate } from "@/services/whatsapp-templates";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">Novo template de WhatsApp</h1>
          <p className="text-muted-foreground">Crie um template reutilizavel para mensagens</p>
        </div>
      </div>
